...
describe('pages/proxy-access-dialog/page', () => {
  it('should display title, remember checkbox and allow/deny buttons', async () => {
    ...
    expect(res).to.have.string(`page_proxyAccessDialog_rememberCheckbox_label[${state.origin}]`)
