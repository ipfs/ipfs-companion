  ...
  return function offlinePage (emit) {
    ...
    <div class="mw5 mw8-ns ph5-ns center pv5">
      ...
      <div class="fl w-70-ns w-100 pl4-ns">
        <h1 class="f2 montserrat fw6 mt0 tc tl-ns">${i18n.getMessage('page_landingOffline_title')}</h1>
        <h2 class="f3 fw6 mt0 mb2">${i18n.getMessage('page_landingOffline_subtitle')}</h2>
