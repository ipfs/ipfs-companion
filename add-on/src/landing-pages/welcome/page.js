  ...
  return html`
    <div class="w-80 flex justify-between-ns aqua f5">
      <div class="flex flex-column">
        <p>IPFS Alpha Demo</p>
        <a class="relative overflow-hidden br2 o-90 glow" style="height: ${videoHeight}px" href="https://www.youtube.com/watch?feature=player_embedded&v=8CMxDNuuAiQ" target="_blank">
      ...
      <div class="flex flex-column">
        ...
        <a class="relative overflow-hidden br2 o-90 glow" style="height: ${videoHeight}px" href="https://www.youtube.com/watch?feature=player_embedded&v=HUVmypx9HGI" target="_blank">
