(() => {
  ...
  function v(l2, u2, i2) {
    ...
    if (
      (arguments.length > 2 &&
        (f2.children = arguments.length > 3 ? n.call(arguments, 2) : i2),
  ...
  function w(n2, l2, u2, i2, t2, o2, r2, f2, s2, a2) {
    ...
    for (u2.__k = [], h2 = 0; h2 < l2.length; h2++)
      if (
        (_2 = u2.__k[h2] =
          (_2 = l2[h2]) == null || typeof _2 == "boolean"
            ? null
            : typeof _2 == "string" ||
              typeof _2 == "number" ||
              typeof _2 == "bigint"
        ...
        if (
          ((_2.__ = u2),
          (_2.__b = u2.__b + 1),
          (p = w2[h2]) === null || (p && _2.key == p.key && _2.type === p.type))
        )
          w2[h2] = void 0;
        else
          for (v2 = 0; v2 < A; v2++) {
        ...
        j(n2, _2, (p = p || e), t2, o2, r2, f2, s2, a2),
          (b2 = _2.__e),
          (v2 = _2.ref) &&
            p.ref != v2 &&
            (g2 || (g2 = []),
            p.ref && g2.push(p.ref, null, _2),
            g2.push(v2, _2.__c || b2, _2)),
          b2 != null
            ? (m2 == null && (m2 = b2),
              typeof _2.type == "function" && _2.__k === p.__k
                ? (_2.__d = s2 = x(_2, s2, n2))
                : (s2 = P(n2, _2, p, w2, b2, s2)),
              typeof u2.type == "function" && (u2.__d = s2))
            : s2 && p.__e == s2 && s2.parentNode != n2 && (s2 = k(p));
      }
    for (u2.__e = m2, h2 = A; h2--; )
      w2[h2] != null &&
        (typeof u2.type == "function" &&
          w2[h2].__e != null &&
          w2[h2].__e == u2.__d &&
          (u2.__d = k(i2, h2 + 1)),
        N(w2[h2], w2[h2]));
  ...
  function j(n2, u2, i2, t2, o2, r2, f2, e2, c2) {
    ...
    i2.__h != null &&
      ((c2 = i2.__h), (e2 = u2.__e = i2.__e), (u2.__h = null), (r2 = [e2])),
      (s2 = l.__b) && s2(u2);
    try {
      n: if (typeof P2 == "function") {
        ...
        (h2.context = x2),
          ...
          h2.getChildContext != null &&
            (t2 = a(a({}, t2), h2.getChildContext())),
          v2 ||
            h2.getSnapshotBeforeUpdate == null ||
            (k2 = h2.getSnapshotBeforeUpdate(y2, p)),
          (A =
            s2 != null && s2.type === d && s2.key == null
              ? s2.props.children
              : s2),
          w(n2, Array.isArray(A) ? A : [A], u2, i2, t2, o2, r2, f2, e2, c2),
          (h2.base = u2.__e),
          (u2.__h = null),
          h2.__h.length && f2.push(h2),
      ...
      (u2.__v = null),
        (c2 || r2 != null) &&
          ((u2.__e = e2), (u2.__h = !!c2), (r2[r2.indexOf(e2)] = null)),
        l.__e(n3, u2, i2);
    }
  }
  function z(n2, u2) {
  ...
  function L(l2, u2, i2, t2, o2, r2, f2, c2) {
    ...
    if ((d2 === "svg" && (o2 = true), r2 != null)) {
      for (; _2 < r2.length; _2++)
        if (
          ...
          (d2 ? s2.localName === d2 : s2.nodeType === 3)
        ) {
          (l2 = s2), (r2[_2] = null);
          break;
        }
    ...
    if (l2 == null) {
      if (d2 === null) return document.createTextNode(p);
      (l2 = o2
        ? document.createElementNS("http://www.w3.org/2000/svg", d2)
        : document.createElement(d2, p.is && p)),
        (r2 = null),
        (c2 = false);
    }
    if (d2 === null) y2 === p || (c2 && l2.data === p) || (l2.data = p);
    else {
      if (
        ((r2 = r2 && n.call(l2.childNodes)),
        (a2 = (y2 = i2.props || e).dangerouslySetInnerHTML),
        (v2 = p.dangerouslySetInnerHTML),
        !c2)
      ) {
        if (r2 != null)
        ...
        (v2 || a2) &&
          ((v2 &&
            ((a2 && v2.__html == a2.__html) || v2.__html === l2.innerHTML)) ||
            (l2.innerHTML = (v2 && v2.__html) || ""));
      }
      if ((C(l2, p, y2, o2, c2), v2)) u2.__k = [];
      else if (
        ...
        w(
          ...
          r2,
          f2,
          r2 ? r2[0] : i2.__k && k(i2, 0),
          c2
        ),
        r2 != null)
      )
        for (_2 = r2.length; _2--; ) r2[_2] != null && h(r2[_2]);
      c2 ||
        ("value" in p &&
          (_2 = p.value) !== void 0 &&
          (_2 !== l2.value ||
            (d2 === "progress" && !_2) ||
            (d2 === "option" && _2 !== y2.value)) &&
  ...
  function S(u2, i2, t2) {
    var o2, r2, f2;
    l.__ && l.__(u2, i2),
      (r2 = (o2 = typeof t2 == "function") ? null : (t2 && t2.__k) || i2.__k),
      (f2 = []),
      j(
        i2,
        (u2 = ((!o2 && t2) || i2).__k = v(d, null, [u2])),
        r2 || e,
        e,
        ...
        for (var u2, i2, t2; (l2 = l2.__); )
          if ((u2 = l2.__c) && !u2.__)
            try {
              if (
                ((i2 = u2.constructor) &&
                  i2.getDerivedStateFromError != null &&
  ...
  var NewTab = (props) => {
    ...
    const openOptionPage = () => {
      import_webextension_polyfill.default.runtime
        .openOptionsPage()
        .then(() => window.close())
        .catch((err) => {
          console.error(
          ...
          import_webextension_polyfill.default.tabs.create({
            url: import_webextension_polyfill.default.runtime.getURL(
          ...
          /* @__PURE__ */ v(
            ...
            /* @__PURE__ */ v(
              ...
              /* @__PURE__ */ v("img", {
                ...
                width: 56,
                height: 56,
                src: import_webextension_polyfill.default.runtime.getURL(
        ...
        /* @__PURE__ */ v(
          ...
          /* @__PURE__ */ v(
            "div",
            {
              class: "flex flex-row justify-between ph2 pv1 cursor-help",
              title:
                "The URL of the gateway, either public or local, you are using to fetch content (change this in Preferences)",
            },
            /* @__PURE__ */ v(
              "div",
              null,
          ...
          /* @__PURE__ */ v(
            ...
            /* @__PURE__ */ v(
              ...
              /* @__PURE__ */ v(
                ...
                "Click to load current page on IPFS"
              )
            )
          )
      ),
            ...
            /* @__PURE__ */ v(
              ...
              /* @__PURE__ */ v(
                ...
                /* @__PURE__ */ v(
                  ...
                  {
                    class:
                      "f5 dib pb2 black flex flex-column current-tab-button",
