  ...
  return (
    <div>
      ...
      <div className="ipfs-gradient-0">
        <header className="flex justify-between">
          ...
          <div className="flex">
            <div className="pa3" onClick={openAboutPage}>
              <img alt="IPFS" width={56} height={56} src={browser.runtime.getURL("/icons/ipfs-logo-on.svg")} />
            </div>
            <div className="flex flex-column">
              ...
              <span>
                <div title="version" className="tc">
                  {online ? (<span title="The version of IPFS your local node is using">
                    0.11.0
                  </span>) : <span title="Your local node is offline">
                    Offline
                  </span>}
                </div>
              </span>
        ...
        <div class="flex flex-column f6">
          <div class="flex flex-row justify-between ph2 pv1 cursor-help" title="The number of other IPFS nodes you can connect to">
            <div><span class="">Peers</span></div>
            <div><span title={peerCount} class="">
              {peerCount}
            </span></div>
          </div>

          <div class="flex flex-row justify-between ph2 pv1 cursor-help"
              title="The URL of the gateway, either public or local, you are using to fetch content (change this in Preferences)">
            <div><span class="">Gateway</span></div>
            <div><span title={gatewayUrl} class="">
              {gatewayUrl}
            </span></div>
          </div>
          ...
          <div class="flex flex-row justify-between ph2 pv1 cursor-help"
          title="The URL of the gateway, either public or local, you are using to fetch content (change this in Preferences)">
            <div><span class="">API</span></div>
            <div><span title={apiURLString} class="">
              {apiURLString}
            </span></div>
          </div>
        </div>
      ...
      <div class="flex justify-between">
        <div class="pa3" onClick={openImportPage}>
          <a class="f6 link dim ba ph3 pv2 mb2 dib black" href="#0">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="nb2" width="22px" height="22px"><path fill="currentColor" d="M71.13 28.87a29.88 29.88 0 100 42.26 29.86 29.86 0 000-42.26zm-18.39 37.6h-5.48V52.74H33.53v-5.48h13.73V33.53h5.48v13.73h13.73v5.48H52.74z"/></svg>
            Import
          </a>
        </div>
        ...
        <div class="pa3" onClick={pinToNode}>
          <a class="f6 link dim ba ph3 pv2 mb2 dib black" href="#0">
            <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="nb2" width="22px" height="22px"><path fill="currentColor" d="M69.69 20.57c-.51-.51-1.06-1-1.62-1.47l-.16-.1c-.56-.46-1.15-.9-1.76-1.32l-.5-.35c-.25-.17-.52-.32-.79-.48A28.27 28.27 0 0050 12.23h-.69a28.33 28.33 0 00-27.52 28.36c0 13.54 19.06 37.68 26 46a3.21 3.21 0 005 0c6.82-8.32 25.46-32.25 25.46-45.84a28.13 28.13 0 00-8.56-20.18zM51.07 49.51a9.12 9.12 0 119.13-9.12 9.12 9.12 0 01-9.13 9.12z"/></svg>
            </span>
            My node
          </a>
        </div>
      ...
      {showReloadNotification && <div class="center mw7" onClick={reloadTab}>
        <aside class="refresh-button f6 link dim ba ph3 pv2 mb2 dib black tc">
          <span class="f7" style="color: #8f8b8b;">IPFS version detected</span>
    ...
    {isIpfsContext ? <div>
      ...
      <div class="flex flex-column tc">
        <div>
          <a class="f5 dib pb2 black flex flex-column current-tab-button"
